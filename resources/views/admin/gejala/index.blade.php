...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .gejala-table thead tr {
        background: linear-gradient(135deg, var(--navy) 0%, #1a3a6e 100%);
    }
    .gejala-table thead th {
        padding: 13px 16px;
        font-size: 0.69rem;
        font-weight: 700;
    ...
    .gejala-table thead th:last-child { border-right: none; }

    .gejala-table tbody tr {
        border-bottom: 1px solid var(--slate-100);
        transition: background .15s;
        animation: rowFadeIn .3s ease both;
    }
    .gejala-table tbody tr:last-child { border-bottom: none; }
    .gejala-table tbody tr:hover { background: #f5f9ff; }
    ...
    .gejala-table td:last-child { border-right: none; }

    .gejala-table tbody tr:nth-child(even) { background: #fafcff; }
    .gejala-table tbody tr:nth-child(even):hover { background: #f0f6ff; }
    ...
    .gejala-table tbody tr:nth-child(1) { animation-delay:.03s }
    .gejala-table tbody tr:nth-child(2) { animation-delay:.06s }
    .gejala-table tbody tr:nth-child(3) { animation-delay:.09s }
...
<div class="gejala-wrap">
    ...
    <div class="page-header">
        <div class="page-title-group">
            ...
            <h2 class="page-title">Data <span class="accent">Gejala</span></h2>
            <p class="page-subtitle">Kelola daftar indikator gejala untuk diagnosa ISPA</p>
        </div>
        <a href="{{ route('gejala.create') }}" class="btn-tambah">
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            <div class="stat-icon indigo"><i class="fas fa-fingerprint"></i></div>
            <div class="stat-info">
                <div class="stat-label">Kode Unik</div>
                <div class="stat-value">{{ $data->count() }}</div>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-icon sky"><i class="fas fa-check-circle"></i></div>
            <div class="stat-info">
                <div class="stat-label">Status Sistem</div>
                <div class="stat-value" style="font-size:1rem;font-weight:700;color:#0284c7;">Siap</div>
            </div>
        </div>
    </div>
    ...
    <div class="table-card">
        ...
        <div class="table-toolbar">
            <div class="search-input-wrap">
                ...
                <input type="text" class="search-input" id="searchInput" placeholder="Cari gejala atau kode...">
            </div>
        ...
        <div style="overflow-x:auto;">
            <table class="gejala-table" id="gejalaTable">
                <thead>
                    <tr>
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <span class="kode-badge">{{ $g->kode }}</span>
                        </td>
                        <td class="nama-cell">{{ $g->nama }}</td>
                        <td>
                            <div class="aksi-cell">
                                <a href="{{ route('gejala.edit', $g->id) }}" class="btn-edit">
                    ...
                    <tr id="emptyRow">
                        <td colspan="4" style="border-right:none;">
                            <div class="empty-state">
                                <div class="empty-icon-wrap"><i class="fas fa-database"></i></div>
                                <div class="empty-title">Belum ada data gejala</div>
                                <div class="empty-sub">Tambahkan data gejala untuk melengkapi basis pengetahuan sistem.</div>
                                <a href="{{ route('gejala.create') }}" class="empty-btn">
        ...
        <div class="table-footer">
            <span class="footer-info">
                ...
                dari <strong>{{ $data->count() }}</strong> data gejala
            </span>
            <span class="footer-info">Panel Admin &mdash; Gejala ISPA</span>
        </div>
        @endif
    </div>
